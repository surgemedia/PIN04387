...
<div class="col-sm-6 col-md-3 col-md-pull-6 side">
	<div class="property-info">
      ...
      <div class="street">
		...
		<i class="icon-ruler" data-toggle="tooltip" data-placement="top" title="Area"><?php echo $the_property_meta['property_land_area'][0].' Sq m'; ?></i>
		<?php if($the_property_meta['property_category'][0]){ ?>
		<i class="icon-house" data-toggle="tooltip" data-placement="top" title="Type"><?php echo $the_property_meta['property_category'][0]; ?></i>
		<?php } ?>
		<?php if($the_property_meta['property_land_fully_fenced'][0]){ ?>
		<i class="icon-fence" data-toggle="tooltip" data-placement="top" title="Fully Fenced"><?php echo $the_property_meta['property_land_fully_fenced'][0] ?></i>
		<?php } ?>
