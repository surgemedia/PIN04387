...
<html lang="en-US">
	<head>
		...
		<link rel="stylesheet" href="<?php echo set_url_scheme( EPL_BR_CSS_STRUCTURE . 'style-front.css') . EPL_BR_CSS_VERSION_CORE; ?>" type="text/css" media="all" />
		...
		<link rel="stylesheet" href="<?php echo set_url_scheme( EPL_BR_CSS . 'style-brochures-custom.css') . EPL_BR_CSS_VERSION; ?>" type="text/css" media="all" />
