...
Plugin URL: http://easypropertylistings.com.au/extension/brochures/
Description: Adds a printable brochure button to Easy Property Listings
Version: 1.2
Author: Merv Barrett
		...
		*/
		...
		private function setup_constants() {
			...
			if ( ! defined( 'EPL_BR_CSS_VERSION_CORE' ) ) {
				if ( defined( 'EPL_RUNNING' ) ) {
					// Load EPL Core CSS
					define( 'EPL_BR_CSS_VERSION_CORE', '?version=' . EPL_PROPERTY_VER );
				} else {
			...
			if ( ! defined( 'EPL_BR_CSS_STRUCTURE' ) ) {
				if ( defined( 'EPL_RUNNING' ) ) {
					// Load EPL Core CSS
					define( 'EPL_BR_CSS_STRUCTURE', EPL_PLUGIN_URL . 'lib/assets/css/' );
				} else {
					// Fallback to copy of core-css
