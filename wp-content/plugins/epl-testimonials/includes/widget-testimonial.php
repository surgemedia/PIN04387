 ...
 * @since 1.0
 */
class EPL_TM_Widget_Testimonial extends WP_Widget {
	function __construct() {
		parent::__construct( false, $name = __('EPL - Testimonial', 'epl-tm') );	
	}
...
add_action( 'widgets_init', create_function('', 'return register_widget("EPL_TM_Widget_Testimonial");') );